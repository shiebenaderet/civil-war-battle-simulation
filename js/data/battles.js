        ...
        historical: {
            ...
            whatWouldYouDo: {
                ...
                confederacy: {
                    ...
                    options: {
                        beginner: ["Keep attacking to finish the job before dark", "Stop and get your soldiers organized again", "Send everyone to attack that one stubborn spot called the Hornets' Nest"],
                        intermediate: ["Keep pushing to finish off Grant's army before dark", "Halt and reorganize your scattered forces", "Concentrate everything on breaking the Hornets' Nest position"],
                        advanced: ["Maintain offensive momentum to destroy Grant's army before Buell's reinforcements arrive", "Halt to reorganize scattered units and resume the assault with coordinated force", "Concentrate all available forces on reducing the Hornets' Nest position blocking your advance"]
                    },
                    feedback: {
                        beginner: ["That's what the Confederate generals tried! But they ran out of daylight. Overnight, 25,000 fresh Union soldiers arrived, and the Confederates lost the battle the next day.", "Smart thinking about staying organized. But Confederate generals were afraid that if they stopped, Union reinforcements would arrive. They kept pushing, but it wasn't enough to win before dark.", "That's what actually happened \u2014 the Confederates focused on the Hornets' Nest. They captured it, but it took six hours. That delay gave Grant time to get reinforcements across the river."],
                        intermediate: ["That's what Johnston attempted, but disorganized troops couldn't maintain the pressure. Johnston himself was killed leading a charge that afternoon. The Confederates ran out of daylight, and 25,000 Union reinforcements arrived overnight.", "Reorganizing might have enabled a more effective assault, but every hour of delay brought Buell's reinforcements closer. The Confederate window to destroy Grant was closing fast.", "This is what happened \u2014 Confederates focused on the Hornets' Nest, eventually capturing it. But the six-hour delay was fatal to their campaign: it gave Grant time to establish a final defensive line and bring reinforcements across the river."],
                        advanced: ["This reflects Johnston's actual approach, but maintaining momentum with disorganized forces proved impossible. Johnston was killed at 2:30 PM leading a charge, and his successor Beauregard lacked Johnston's aggressive drive. The Confederates ran out of daylight \u2014 a fatal delay that allowed Buell's 25,000 reinforcements to cross the Tennessee overnight.", "Operational reorganization had merit but presented a critical dilemma: every hour spent consolidating brought Buell's army closer. The Confederacy's narrow window to destroy Grant before reinforcement required accepting tactical disorder in exchange for strategic tempo.", "This mirrors the actual Confederate decision, and it proved to be a Pyrrhic success. Reducing the Hornets' Nest consumed approximately six hours and the life of General Johnston \u2014 time the Confederacy could not afford. The position's stubborn defense fulfilled its strategic purpose of buying Grant enough time for reinforcement."]
                    }
                }
            },
            whatHappened: {
        ...
        historical: {
            ...
            whatWouldYouDo: {
                union: {
                    ...
                    options: {
                        beginner: ["Attack everywhere at the same time so Lee can't move soldiers around", "Hit the left side first, then the right, then the middle", "Get behind Lee and trap his whole army against the river"],
                        intermediate: ["Attack everywhere at once to overwhelm Lee's thin lines", "Hit one flank hard, then the other, then the center", "Cut off Lee's retreat across the Potomac and trap his army"],
                        advanced: ["Launch a simultaneous assault across the entire front to prevent Lee from shifting reserves", "Execute sequential attacks on the flanks followed by a decisive blow to the weakened center", "Maneuver to cut Lee's line of retreat across the Potomac, trapping his army against the river"]
                    },
                    feedback: {
                        beginner: ["Great idea! If McClellan had attacked everywhere at once, Lee's small army couldn't have covered every spot. But McClellan was too cautious and attacked in parts, giving Lee time to move soldiers around.", "That's actually what McClellan did \u2014 and it didn't work well. By hitting one spot at a time, Lee could move his few soldiers to each danger area. If McClellan had attacked everywhere at once, Lee couldn't have done that.", "That's a brilliant strategy that could have ended the war! Unfortunately, McClellan was too careful and slow. He never tried to cut off Lee's escape, and Lee retreated safely to Virginia the next day."],
                        intermediate: ["The strongest choice, and one McClellan didn't make. A coordinated assault along the entire front would have prevented Lee from shifting his thin forces. Instead, McClellan attacked in three separate waves, giving Lee time to reinforce each threatened sector.", "This is essentially what McClellan did \u2014 sequential attacks north, south, then center. It gave Lee time to shift his outnumbered forces to meet each threat. The result was the bloodiest day in American history, but not the decisive victory it should have been.", "Perhaps the most devastating option available. Cutting Lee's retreat would have trapped his army against the Potomac. McClellan's failure to pursue after the battle \u2014 letting Lee escape to Virginia \u2014 frustrated Lincoln so much that he eventually fired McClellan."],
                        advanced: ["Arguably the optimal strategy given the intelligence advantage. A simultaneous assault would have exploited the fundamental weakness of Lee's position: his 45,000 troops simply could not defend every sector against 87,000 attackers. McClellan's failure to coordinate his attacks remains one of the war's great missed opportunities.", "This approximates McClellan's actual approach, and it squandered the intelligence advantage. Sequential attacks allowed Lee to employ interior lines, shifting reserves to each threatened sector. The result was a tactical draw rather than the annihilating victory the situation demanded.", "Strategically the most ambitious option and potentially war-ending. Interposing between Lee and the Potomac fords would have created a Cannae-like encirclement. McClellan's chronic overestimation of Confederate strength \u2014 despite holding Lee's actual plans \u2014 made him too cautious to attempt it."]
                    }
                },
                confederacy: {
                    prompt: {
        ...
        historical: {
            ...
            whatWouldYouDo: {
                union: {
                    ...
                    options: {
                        beginner: ["Attack now while Lee's army is split in half!", "Stay in your strong position and let Lee come to you", "Move out of the forest to open ground where your bigger army can fight better"],
                        intermediate: ["Attack immediately while Lee's army is divided", "Hold your strong defensive positions and let Lee come to you", "Withdraw to open ground where your numbers matter more"],
                        advanced: ["Launch an immediate assault to defeat Lee's divided forces in detail", "Maintain your defensive positions and force Lee to attack your superior numbers", "Withdraw to open terrain where your numerical and artillery advantages can be fully employed"]
                    },
                    feedback: {
                        beginner: ["Great instinct! If Hooker had attacked while Lee's army was split, he could have beaten each half separately. Instead, Hooker hesitated and stayed put, giving Lee time to pull off his surprise attack.", "That sounds safe, but it's what Hooker did \u2014 and it was a mistake! By staying still, he let Lee and Jackson plan a sneaky flanking attack that smashed the Union right side.", "That's actually really smart thinking! The forest helped Lee's smaller army hide. In the open, Hooker's huge army and cannons would have crushed Lee. But Hooker lost his nerve and didn't move."],
                        intermediate: ["Exactly right \u2014 this was the moment to strike. Hooker had reports of Confederate movement but lost his nerve and went defensive instead. Had he attacked while Jackson was on the march, Lee's divided army could have been destroyed.", "This is what Hooker chose, and it surrendered the initiative entirely. By halting in defensive positions, Hooker allowed Lee and Jackson to execute the very flanking maneuver that destroyed his right flank at dusk.", "A sound strategic concept that would have neutralized the Wilderness advantage. But Hooker's sudden loss of confidence \u2014 he reportedly said 'I just lost faith in Joe Hooker' \u2014 prevented any decisive action."],
                        advanced: ["Strategically optimal given the intelligence available. Attacking a divided enemy force is a fundamental principle of warfare. However, Hooker inexplicably abandoned the offensive and assumed defensive positions, surrendering the initiative at precisely the moment when Lee was most vulnerable. This failure of nerve allowed Jackson to complete his flanking march unmolested.", "Hooker's actual decision, and it proved catastrophic. A defensive posture ceded the initiative to a commander renowned for audacity. By halting in the Wilderness, Hooker negated his numerical superiority while allowing Lee to execute the very maneuver that would destroy the Union right flank.", "Arguably the most strategically sound option, as the Wilderness terrain was Lee's greatest ally. However, Hooker's paralysis in the face of Lee's aggression meant that no coherent movement \u2014 forward, backward, or lateral \u2014 was executed, leaving 130,000 troops passive while 28,000 Confederates marched to their flank."]
                    }
                },
                confederacy: {
                    prompt: {
        ...
        historical: {
            ...
            whatWouldYouDo: {
                union: {
                    ...
                    options: {
                        beginner: ["Try one more big attack with even more soldiers", "Surround the city and don't let any food in until they give up", "Use the Navy's big guns to blast the city from the river"],
                        intermediate: ["Launch another massive assault with more troops", "Surround the city and starve it into surrender", "Bombard the city with naval guns until it falls"],
                        advanced: ["Commit to a third and larger assault, concentrating overwhelming force on the weakest sector", "Invest the city completely and reduce the garrison through systematic siege and starvation", "Employ sustained naval bombardment to degrade fortifications and break the garrison's will"]
                    },
                    feedback: {
                        beginner: ["Brave idea, but the first two attacks already failed. Grant decided that another attack would just get more soldiers killed. He chose to surround the city and wait instead \u2014 and it worked!", "That's exactly what Grant did! He surrounded Vicksburg so nothing could get in or out. After 47 days, the people inside were so hungry they ate rats and shoe leather. The city finally gave up on July 4, 1863.", "The Navy did try this! Gunboats fired at the city, but the cliffs were so high and the walls so thick that the shells didn't do enough damage. Grant knew he needed to starve the city out."],
                        intermediate: ["Understandable determination, but Grant wisely recognized that the fortifications were simply too strong for frontal assault. A third attack would have produced casualties without results. The siege was the smarter play.", "Exactly Grant's decision. He established a complete encirclement and settled in for a 47-day siege. Soldiers and civilians slowly starved until Pemberton surrendered on July 4, 1863. Patience proved more effective than courage against fortified positions.", "Naval bombardment was tried throughout the siege but couldn't breach fortifications built into 200-foot bluffs. The guns kept pressure on the garrison, but it was starvation \u2014 not shells \u2014 that ultimately forced the surrender."],
                        advanced: ["Grant had already demonstrated at the May 19 and May 22 assaults that Vicksburg's fortifications could not be carried by direct assault. A third attempt would have repeated the same bloody calculus. Grant's strategic maturity showed in his willingness to accept the slower but surer method of siege.", "This mirrors Grant's actual decision and represents a masterclass in strategic patience. The 47-day siege starved the garrison into submission without the prohibitive casualties of another assault. Grant understood that time was his ally: no Confederate relief force could break through his encirclement.", "Naval bombardment supplemented the siege but could not independently reduce fortifications built into natural bluffs. Admiral Porter's gunboats maintained constant pressure, but Grant recognized that the fortress's fall required the methodical strangulation of siege rather than the application of firepower alone."]
                    }
                },
                confederacy: {
                    prompt: {
                    ...
                    options: {
                        beginner: ["Try to break out of the trap with your whole army", "Hold on and wait for a rescue army to come", "Give up now while your soldiers are still healthy enough to negotiate good terms"],
                        intermediate: ["Attempt a breakout with your entire garrison", "Hold out and hope for a relief force to arrive", "Negotiate surrender terms while you still have bargaining power"],
                        advanced: ["Attempt a breakout through Grant's siege lines with the entire garrison", "Continue to hold and await a Confederate relief expedition", "Negotiate surrender terms from a position of relative strength before the garrison deteriorates further"]
                    },
                    feedback: {
                        beginner: ["A breakout could save the army, but Grant had so many soldiers surrounding the city that there was no gap to escape through. Pemberton decided it was too risky.", "That's what Pemberton tried. He waited and waited for help, but no rescue army ever made it through. After 47 days, his soldiers were too weak to fight and he had to surrender.", "Smart thinking about timing! Pemberton waited too long to negotiate. By the time he surrendered on July 4, his soldiers were so starved and sick that he had almost no bargaining power left."],
                        intermediate: ["A breakout was considered but deemed impossible \u2014 Grant's encirclement was too tight and the garrison too weakened by hunger. The attempt would likely have resulted in the army's destruction in the open.", "Pemberton's choice, and it ended in failure. No Confederate relief force could break through Grant's lines. After 47 days, the garrison was too starved and sick to continue. The delay only worsened surrender terms.", "Arguably the wisest option. Earlier negotiation would have secured better terms while the garrison still had fighting strength. Pemberton's delay \u2014 hoping for relief that never came \u2014 meant surrendering a weakened, starving army with no leverage."],
                        advanced: ["A breakout attempt against Grant's fortified siege lines would have required the starving garrison to execute an offensive operation against a superior force in prepared positions \u2014 effectively inverting the defenders' disadvantage that had protected Vicksburg. The operation was operationally infeasible given the garrison's deteriorated condition.", "Pemberton's actual decision, ultimately driven by hope for Johnston's relief expedition that never materialized. The delay consumed what remained of the garrison's combat effectiveness without achieving any strategic benefit. Each day of holding out simply increased civilian suffering and decreased bargaining leverage.", "The most strategically sound option. Negotiating while the garrison retained combat capability would have secured better terms and spared weeks of civilian suffering. Grant eventually offered parole rather than imprisonment \u2014 terms he might not have offered to a stronger garrison, but which demonstrated his pragmatic approach to ending the siege."]
                    }
                }
            },
            whatHappened: {
        ...
        historical: {
            ...
            whatWouldYouDo: {
                union: {
                    ...
                    options: {
                        beginner: ["Make the center strong and wait for Lee to attack uphill", "Send soldiers to protect both sides so Lee can't get around you", "Surprise Lee by attacking first before he's ready"],
                        intermediate: ["Strengthen the center and wait for Lee to attack uphill", "Reinforce both flanks to prevent being surrounded", "Launch a surprise counterattack before Lee is ready"],
                        advanced: ["Concentrate reserves in the center, relying on terrain to defend the flanks", "Reinforce both flanks to prevent envelopment while maintaining a central reserve", "Seize the initiative with a preemptive counterattack before Lee can organize his assault"]
                    },
                    feedback: {
                        beginner: ["A strong center helped, but the sides turned out to be more important! On Day 2, Lee attacked both sides. If a few more Union soldiers hadn't rushed to Little Round Top at the last second, the whole battle might have been lost.", "Smart thinking! That's close to what actually happened. Meade kept soldiers ready to help wherever needed. When Lee attacked the sides, Union soldiers barely held on at Little Round Top \u2014 one of the closest calls of the whole war.", "Bold, but risky! The high ground was such a great defensive position that leaving it to attack would throw away your biggest advantage. Meade wisely let Lee come to him."],
                        intermediate: ["A strong center proved crucial during Pickett's Charge on Day 3, but the real crisis came on Day 2 when Lee attacked both flanks. Little Round Top was nearly lost \u2014 only a desperate bayonet charge by the 20th Maine saved the position.", "Closest to Meade's actual approach. He maintained a strong central reserve and reinforced threatened points as needed. The flexibility of his defensive line \u2014 the famous 'fishhook' shape \u2014 allowed rapid shifting of troops to meet each Confederate thrust.", "Aggressive, but it would have surrendered the enormous advantage of the high ground. Lee was hoping Meade would do something like this. The Union's defensive position was so strong that attacking into it would have been the mistake."],
                        advanced: ["While the center proved critical during Pickett's Charge, the decisive moments came on the flanks. Little Round Top was nearly overrun on Day 2 \u2014 Chamberlain's 20th Maine executed a desperate bayonet charge that may have saved the entire position. A purely center-focused defense risked losing the flanks that anchored the line.", "This approximates Meade's actual defensive approach. The 'fishhook' formation allowed interior lines and rapid reinforcement of threatened sectors. Meade's flexibility in shifting reserves to meet each Confederate thrust \u2014 without abandoning the central position \u2014 was operationally sound and historically validated.", "While seizing the initiative has tactical merit, it would have surrendered the decisive advantage of the high ground. Lee's entire operational plan depended on forcing the Union off its defensive terrain. A Union counterattack into open ground would have played directly into Confederate strengths."]
                    }
                },
                confederacy: {
                    prompt: {
        ...
        historical: {
            ...
            whatWouldYouDo: {
                ...
                confederacy: {
                    ...
                    options: {
                        beginner: ["Attack everywhere at once along the whole line", "Look for a weak spot and send everyone there", "Wait for the enemy to mess up, then attack"],
                        intermediate: ["Launch an all-out attack along the entire line", "Probe for a weak point and concentrate your forces there", "Wait for the enemy to make a mistake, then strike"],
                        advanced: ["Launch a general assault along the entire front to prevent the enemy from consolidating", "Concentrate Longstreet's veterans at the decisive point once reconnaissance identifies a vulnerability", "Maintain pressure while waiting for the enemy's disposition to create an exploitable opportunity"]
                    },
                    feedback: {
                        beginner: ["Bragg tried attacking all along the line on Day 1, but it was messy and didn't break through. The big breakthrough came on Day 2 when the Confederates found a gap in the Union line and poured through it!", "This is close to what happened! On Day 2, Longstreet's soldiers found a huge gap in the Union line and smashed through it. Two-thirds of the Union army ran away. Only General Thomas on Snodgrass Hill kept the whole army from being destroyed.", "That's basically what happened! A confusing Union order created a big gap in their line, and Longstreet's veterans charged through it. Patience and waiting for the right moment paid off big time."],
                        intermediate: ["Bragg's initial approach on Day 1, but broad-front assaults dissipated Confederate combat power without achieving a breakthrough. The decisive moment came on Day 2 when Longstreet found and exploited a gap created by a Union mistake.", "Close to what actually happened. On Day 2, Longstreet identified and concentrated his veterans at a gap accidentally created by a confused Union order. The breakthrough routed two-thirds of the Union army \u2014 exactly the result of finding and exploiting a weak point.", "Patience proved decisive here. On Day 2, a confused Union order pulled a division from line, creating an unintended gap. Longstreet's veterans poured through, routing two-thirds of the Union army. The Confederate victory came from exploiting an enemy mistake rather than creating one."],
                        advanced: ["Bragg's Day 1 approach of broad-front assaults proved costly and inconclusive, dissipating combat power across the entire line without achieving decisive results. The breakthrough came only when Longstreet's concentrated force exploited a specific vulnerability on Day 2.", "This most closely mirrors the actual Confederate success. Longstreet concentrated his veteran corps at the gap created by Rosecrans' confused order, achieving the kind of focused penetration that broad-front attacks could not. The result was the rout of two-thirds of the Union army.", "This approximates how the breakthrough actually occurred. The Confederate victory resulted not from superior offensive planning but from the exploitation of an enemy error \u2014 a confused order that created a gap in the Union line. Longstreet's readiness to exploit the opportunity with concentrated force was the decisive factor."]
                    }
                }
            },
            whatHappened: {
